...
var totalCount=maliciousCount+legitCount;
var outRequest=(maliciousCount/totalCount)*100;
//alert(outRequest);
...
totalCount=maliciousCount+legitCount;
outRequest=(maliciousCount/totalCount)*100;
...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if (request.action == "alert_user")
            alert("Warning!!! Malicious content is being loaded");
        setTimeout(function () { sendResponse({ status: true }); }, 1);
        return true;
    });